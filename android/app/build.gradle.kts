...
android {
    namespace = "com.example.ah_ticketing_prod"
    ...
    defaultConfig {
        ...
        applicationId = "com.example.ah_ticketing_prod"
    ...
    signingConfigs {
        create("release") {
            if (keystoreProperties.isNotEmpty()) {
                ...
                storeFile = keystoreProperties["storeFile"]?.let { file(it) } ?: throw GradleException("Missing storeFile in key.properties")
